...
export const MenubarCheckboxItem: Component<MenuCheckboxItemProps> = (props) => {
  ...
  return (
    <KBMenubar.CheckboxItem
      class={`menubar__checkbox-item ${menuItemColor[color()][styleType()]} ${menuItemSizeKey[size()]} ${menuItemEdgeCurve[curve()]}`}
    ...
    >
      ...
      <KBMenubar.ItemIndicator
        class={`menubar__item-indicator ${menuIndicatorSizeKey[size()]}`}
      >
        <CheckIcon />
      </KBMenubar.ItemIndicator>
    </KBMenubar.CheckboxItem>
