...
const Popover: ParentComponent<PopoverProps> = (props) => {
  ...
  return (
    ...
    >
      ...
      <KBPopover.Portal>
        <KBPopover.Content
          class={`popover__content shadow-lg ${contentColorKey[color]} ${contentEdgeCurve[curve]} ${contentSizeKey[size]} animate-popover-content-hide ui-expanded:animate-popover-content-show`}
        >
