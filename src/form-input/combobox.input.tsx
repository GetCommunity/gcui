...
import { ComboboxInputProps } from './input.types';
...
const ComboboxInput = <T,>(props: ComboboxInputProps<T>) => {
  ...
  return (
    ...
    >
      ...
      <Combobox.Control
        class='combobox__control ui-invalid:border-red-700 inline-flex w-full min-w-52 justify-between rounded border border-solid border-gray-400 bg-white px-2 py-1 text-gray-900 outline-none outline-0 transition-colors hover:border-gray-600'
