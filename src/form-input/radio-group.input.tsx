...
import { RadioGroupInputProps } from './input.types';
        ...
        <For each={props.options}>
          {(value) => (
            <RadioGroup.Item value={value} class='radio flex items-center'>
              ...
              <RadioGroup.ItemControl class='radio__control border peer-focus-within:ui-invalid:outline-red-700 ui-checked:border-blue-700 ui-checked:bg-blue-500 ui-checked:ui-invalid:border-red-700 ui-checked:ui-invalid:bg-red-500 flex h-5 w-5 items-center justify-center rounded-[10px] border-solid border-gray-400 bg-gray-100 hover:cursor-pointer peer-focus-within:outline peer-focus-within:outline-1 peer-focus-within:outline-offset-1 peer-focus-within:outline-blue-500'>
