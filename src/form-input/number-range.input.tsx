...
import { NumberRangeSliderProps } from './input.types';
    ...
    <>
      ...
      >
        ...
        <Slider.Track class='slider-track relative h-2 w-full rounded-full bg-gray-300'>
          <Slider.Fill class='slider-range ui-invalid:bg-red-600 absolute h-full rounded-full bg-blue-500' />
          <Slider.Thumb class='slider-thumb focus:outline-3 ui-invalid:bg-red-600 ui-invalid:focus:outline-red-300 -top-1 block h-4 w-4 rounded-full bg-blue-500 hover:shadow-sm focus:shadow-sm focus:outline focus:outline-blue-300'>
            <Slider.Input />
          </Slider.Thumb>
          <Show when={props.multiple || props.value.length > 1}>
            <Slider.Thumb class='slider-thumb slider-thumb focus:outline-3 ui-invalid:bg-red-600 ui-invalid:focus:outline-red-300 -top-1 block h-4 w-4 rounded-full bg-blue-500 hover:shadow-sm focus:shadow-sm focus:outline focus:outline-blue-300'>
              <Slider.Input />
            </Slider.Thumb>
          </Show>
        </Slider.Track>
