...
import { ComboboxMultipleInputProps } from './input.types';
  ...
  return (
    <Combobox<T>
      ...
      itemComponent={(props) => (
        <Combobox.Item
          item={props.item}
          class='combobox__item ui-disabled:text-gray-700 ui-disabled:opacity-50 ui-highlighted:bg-blue-400 ui-highlighted:text-white ui-highlighted:outline-none relative flex h-8 select-none items-center justify-between rounded-sm px-2 py-1 text-gray-900 outline-none'
        >
          <Combobox.ItemLabel>
    ...
    >
      ...
      <Combobox.Control<T>
        class='combobox__control ui-invalid:border-red-700 inline-flex w-full min-w-52 justify-between gap-2 rounded border border-solid border-gray-400 bg-white text-gray-900 outline-none outline-0 transition-colors hover:border-gray-600'
      ...
      <Combobox.Portal>
        ...
        <Combobox.Content class='combobox__content border rounded border-solid border-gray-400 bg-white shadow-sm outline-0'>
          <Combobox.Listbox class='combobox__listbox children:my-1 children-hover:bg-blue-500 m-0 max-h-80 overflow-y-auto px-2 py-1' />
        </Combobox.Content>
      </Combobox.Portal>
