    ...
    >
      ...
      <Switch>
        <Match when={props.type === 'text'}>
          <TextField.Input
            class='text-field__input w-100 border ui-invalid:border-red-700 ui-invalid:text-red-800 inline-flex w-full min-w-52 rounded border-solid border-gray-400 bg-white px-2 py-1.5 outline-none transition-all placeholder:text-gray-500 focus-within:outline focus-within:outline-1 focus-within:outline-offset-1 focus-within:outline-blue-500 hover:border-gray-600 focus-visible:outline-2'
        ...
        <Match when={props.type === 'textarea'}>
          <TextField.TextArea
            class='textarea-field__inputarea hover:border-gray700 w-100 border ui-invalid:border-red-700 ui-invalid:text-red-800 inline-flex w-full min-w-52 rounded border-solid border-gray-400 bg-white px-2 py-1.5 outline-none transition-all placeholder:text-gray-500 focus-within:outline focus-within:outline-1 focus-within:outline-offset-1 focus-within:outline-blue-500 hover:border-gray-600 focus-visible:outline-2'
            placeholder={props.placeholder}
