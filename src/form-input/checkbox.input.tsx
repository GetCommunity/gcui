...
export default function CheckboxInput(props: CheckboxInputProps) {
  return (
    ...
    >
      ...
      <Checkbox.Control class='checkbox__control border ui-invalid:border-red-600 ui-invalid:bg-red-100 ui-checked:border-blue-300 ui-checked:bg-blue-500 ui-checked:text-white mt-1 h-5 w-5 rounded border-solid border-gray-500 bg-gray-300 hover:cursor-pointer peer-focus-visible:outline-2 peer-focus-visible:outline-gray-800'>
        <Checkbox.Indicator>
          <CheckIcon />
        </Checkbox.Indicator>
      </Checkbox.Control>
