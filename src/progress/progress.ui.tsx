...
export default function ProgressBar(props: ProgressBarProps) {
  ...
  return (
    ...
    >
      ...
      <KBProgress.Track
        class={`progress__track ${progressSizeKey[size]} ${progressEdgeCurve[curve]}`}
      >
        <KBProgress.Fill
          class={`progress__fill data-[progress=loading]:animate-progress-pulse ${progressColorKey[color]} ${progressEdgeCurve[curve]}`}
        />
      </KBProgress.Track>
    </KBProgress>
  );
